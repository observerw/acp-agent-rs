...
This repository uses `pre-commit` for local checks.
...
- `pre-commit`: whitespace/file sanity checks, `cargo fmt --all -- --check`, `cargo clippy --all-targets --locked -- -D warnings`
